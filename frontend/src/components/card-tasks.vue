...
<template>
  <div id="card-tasks">
    ...
    <gridView  :data-source="dataSource" :fields="fieldName" :doctype="doctype" :image="parentImages" :data="responseData"
    @update:selectedRowKeys="emit('update:selectedRowKeys', $event)" :isSaveFilter="true" :showMultiSelect="false" @row-clicked="handleRowClicked"/>
  </div>
</template>
